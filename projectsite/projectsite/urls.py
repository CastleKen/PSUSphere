...
from studentorg.views import HomePageView, OrganizationList, OrganizationCreateView, OrganizationUpdateView, OrganizationDeleteView, OrgMemberList, StudentList, StudentCreateView, StudentUpdateView, StudentDeleteView
